...
![图4-1][images/4-1 main interface.png]
...
![图4-2][4-2 main interface tool bar.png]
### 自定义通信参数功能
...
![图4-11][4-11 send bar double click.png]
#### 发送消息头部分自定义
##### 前置要求
自定义发送消息头部，需先选择头部结构csv文件，然后点击设置头部按钮，弹出设置头部窗口，进行发送消息的头部数据设置，如下图：
![图4-12][4-12 head file button.png]
设置头部窗口各列含义说明如下：
列名	说明
name	代表字段名称，简单表示字段作用。
...
##### 操作说明
![图4-13][4-13 head input window.png]
